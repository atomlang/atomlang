 ...
 * 
 * @copyright Copyright (c) 2021 Krisna Pranav GPL License
 * 
 */
...
#include "atomlang_visitor.h"
#include "atomlang_symboltable.h"
...
/**
 * @brief Declaration Initializers
 * 
 * @class gnode class
 * 
 * @param token 
...
/**
 * @brief Expressions initializers
 * 
 * @class gnode bool funcs
 * 
 * @param node1 
 * @param node2 
 * @return true 
