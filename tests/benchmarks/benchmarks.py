...
## Map from systems to the relative atomlang binary path.
SYSTEM_TO_BINARY_PATH = {
  "Windows": "..\\..\\build\\release\\bin\\atomlang.exe",
  "Linux"  : "../../build/release/atomlang",
  "Darwin" : "../../build/release/atomlang",
}
